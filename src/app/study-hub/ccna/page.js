...
const PASSING = { score: 825, outOf: 1000, pct: 82.5 }
    ...
    <div>
      <div style={{ marginBottom: '32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          ...
          <h1 style={{ color: ACCENT, fontSize: '28px', fontWeight: '700', marginBottom: '4px' }}>CCNA</h1>
          <p style={{ color: 'var(--text-secondary)' }}>Cisco Certified Network Associate</p>
        </div>
      ...
      <div style={{ backgroundColor: 'rgba(0,128,255,0.06)', border: '1px solid var(--accent-blue)', borderRadius: '10px', padding: '16px 20px', marginBottom: '20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div>
          ...
          <div style={{ color: 'var(--text-secondary)', fontSize: '13px' }}>You need <strong style={{ color: 'var(--text-primary)' }}>825 out of 1000</strong> to pass the real CCNA exam — that's <strong style={{ color: 'var(--text-primary)' }}>82.5%</strong>.</div>
        </div>
        <div style={{ textAlign: 'right' }}>
          <div style={{ color: ACCENT, fontSize: '28px', fontWeight: '700', lineHeight: 1 }}>825</div>
          <div style={{ color: 'var(--text-secondary)', fontSize: '11px' }}>out of 1000</div>
        </div>
      </div>
      ...
      {!loading && (
        <div style={{ backgroundColor: 'var(--surface)', border: '1px solid var(--warning-border)', borderRadius: '10px', padding: '20px', marginBottom: '24px' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '12px', marginBottom: '12px' }}>Your weakest CCNA domains — study these first</p>
          {weak.length === 0 ? (
