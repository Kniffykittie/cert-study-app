    ...
    <div>
      <div style={{ marginBottom: '32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          ...
          <h1 style={{ color: 'var(--error)', fontSize: '28px', fontWeight: '700', marginBottom: '4px' }}>Security+</h1>
          <p style={{ color: 'var(--text-secondary)' }}>CompTIA Security+</p>
        </div>
        <Link href="/study-hub/test">
          <button style={{ backgroundColor: 'var(--error)', color: '#E8E8E8', border: 'none', borderRadius: '8px', padding: '10px 20px', fontSize: '14px', fontWeight: '600', cursor: 'pointer' }}>
      ...
      <div style={{ backgroundColor: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '10px', padding: '24px', marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '32px' }}>
        <div>
          ...
          <div style={{ color: 'var(--error)', fontSize: '48px', fontWeight: '700' }}>45%</div>
        </div>
        <div style={{ flex: 1 }}>
          <div style={{ height: '8px', backgroundColor: 'var(--border)', borderRadius: '4px', overflow: 'hidden' }}>
            <div style={{ height: '100%', width: '45%', backgroundColor: 'var(--error)', borderRadius: '4px' }} />
          </div>
        </div>
