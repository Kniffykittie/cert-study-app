    ...
    return (
      <div style={{ minHeight: '100vh', backgroundColor: 'var(--background)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center', maxWidth: '400px', padding: '0 24px' }}>
          <div style={{ fontWeight: '800', fontSize: '28px', color: 'var(--accent-blue)', marginBottom: '24px' }}>CSA</div>
          <div style={{ backgroundColor: 'var(--success-border)', border: '1px solid var(--success)', borderRadius: '10px', padding: '24px', marginBottom: '24px' }}>
            <p style={{ color: 'var(--success)', fontSize: '14px' }}>Account created! Check your email to confirm your address, then sign in.</p>
          </div>
          <Link href="/login" style={{ color: 'var(--accent-blue)', fontSize: '14px' }}>Back to Sign In</Link>
        </div>
      </div>
    )
  }
    ...
    <div style={{ minHeight: '100vh', backgroundColor: 'var(--background)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ width: '100%', maxWidth: '400px', padding: '0 24px' }}>
        ...
        <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div>
            <label style={{ color: 'var(--text-secondary)', fontSize: '12px', display: 'block', marginBottom: '6px' }}>Confirm Password</label>
            <input
              type="password"
              value={confirm}
