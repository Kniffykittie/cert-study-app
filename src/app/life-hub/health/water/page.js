...
export default function DrinksHydrationPage() {
  ...
  return (
    <div style={{ maxWidth: 640, margin: '0 auto', padding: '24px 16px' }}>
      ...
      <h1 style={{ color: A, fontSize: 22, fontWeight: 700, margin: '0 0 4px' }}>💧 Drinks & Hydration</h1>
      ...
      {showWhy && (
        <div style={{ marginBottom: '24px', backgroundColor: `${A}0d`, border: `1px solid ${A}30`, borderRadius: '10px', padding: '14px 16px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
          <div style={{ fontSize: '12px', fontWeight: '700', color: A, textTransform: 'uppercase', letterSpacing: '0.06em' }}>Why hydration tracking pays off</div>
          {[
      ...
      <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 14, padding: '18px 20px', marginBottom: 16 }}>
        <div style={{ fontSize: 12, fontWeight: 700, color: A, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 12 }}>💧 Quick Add Water</div>
      ...
      <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 14, padding: '18px 20px', marginBottom: 16 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4, gap: 8 }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: A, textTransform: 'uppercase', letterSpacing: '0.08em' }}>🥤 Log a Drink</div>
          <Link href="/life-hub/nutrition/add-food?slot=drink" style={{ fontSize: 11, color: A, textDecoration: 'none', fontWeight: 600, border: `1px solid ${A}59`, borderRadius: 6, padding: '3px 8px', backgroundColor: `${A}14`, whiteSpace: 'nowrap' }}>
            🔍 Search & log →
          </Link>
        </div>
        ...
        {savedDrinks.length > 0 && (
          <div style={{ marginBottom: 12 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
              <div style={{ fontSize: 11, color: A, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em' }}>⭐ My Drinks</div>
      ...
      {allEntries.length > 0 && (
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 14, padding: '18px 20px', marginBottom: 16 }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: A, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 10 }}>📋 Today's Log</div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
      ...
      {allEntries.length > 0 && (() => {
        ...
        return (
          <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 14, padding: '18px 20px', marginBottom: 16 }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: A, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 14 }}>⏰ Hydration Timing Today</div>
      ...
      <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 14, padding: '18px 20px' }}>
        <div style={{ fontSize: 12, fontWeight: 700, color: A, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 14 }}>📈 Last 7 Days</div>
