    ...
    <div>
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{color: '#0080FF', fontSize: '48px', fontWeight: '700'}}>71%</div>
        </div>
        <div style={{flex: 1}}>
          <div style={{
            height: '8px',
      ...
      <div style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px'}}>
        ...
        <div style={{
          ...
          <h2 style={{color: '#2ECC71', fontSize: '16px', fontWeight: '600', marginBottom: '4px'}}>
            Strong Topics
          </h2>
          <p style={{color: 'var(--text-secondary)', fontSize: '12px', marginBottom: '16px'}}>
            Consistently answering correctly
          </p>
          <p style={{color: 'var(--text-secondary)', fontSize: '14px'}}>
            No data yet. Take a test to get started.
          </p>
        </div>
        ...
        <div style={{
          ...
          <h2 style={{color: '#F1C40F', fontSize: '16px', fontWeight: '600', marginBottom: '4px'}}>
            Average Topics
          </h2>
          <p style={{color: 'var(--text-secondary)', fontSize: '12px', marginBottom: '16px'}}>
            Inconsistent — needs more practice
          </p>
          <p style={{color: 'var(--text-secondary)', fontSize: '14px'}}>
            No data yet. Take a test to get started.
          </p>
        ...
        <div style={{
          ...
          <h2 style={{color: '#CC0000', fontSize: '16px', fontWeight: '600', marginBottom: '4px'}}>
            Weak Topics
          </h2>
          <p style={{color: 'var(--text-secondary)', fontSize: '12px', marginBottom: '16px'}}>
            Consistently missing — priority focus
          </p>
          <p style={{color: 'var(--text-secondary)', fontSize: '14px'}}>
            No data yet. Take a test to get started.
          </p>
