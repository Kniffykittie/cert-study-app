  ...
  app/
    ...
    life-hub/
      ...
      workouts/
        ...
        stretching/page.js             Stretching & Mobility — daily recommendations based on today's workout body parts + sore spots; session type toggle (Pre/Post/Standalone); dynamic+static sections with check-off cards; timing label below stretch name; "Why?" toggle reveals why field; injury-aware copy block when sore spot matches muscle group; sticky log button; duration tracked from first check
