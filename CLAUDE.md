  ...
  app/
    api/
      ...
      nutrition/
        ...
        meal-insight/route.js          POST — Haiku session-scoped meal analysis (2 sentences); fires when user taps "Done" after editing mode; rate-limited 6/day; accepts session_foods, slots_touched, is_catchup, day_totals, targets; uses getUser() + is_disabled check
