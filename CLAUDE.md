...
src/
  app/
    api/
      ...
      life-hub/
        daily-brief/route.js           GET ?window=(morning|afternoon|evening) returns cached brief for that window; POST accepts window in body — morning gathers 10+ tables + calls Claude; evening gathers today's data (past-tense); afternoon is a side effect of checkin/insight; uses getUser() + is_disabled check
