...
src/
  app/
    ...
    life-hub/
      ...
      page.js                          Life Hub landing — 3-zone dashboard: Zone 1 = 4-pill status bar (calories/workouts/steps/water, section-colored); Zone 2 = Three Daily Brief cards (morning=purple always visible, afternoon=yellow shown when check-in insight exists, evening=indigo shown after 6pm or when generated; each collapsible, color-coded); Zone 3 = 2×2 live section summary cards (Nutrition/Workouts/Health/Goals with real data + left-border accents); below: Recovery Score (5-component 0–100), Smart Contextual Check-In, 28-day heatmap
      ...
      workouts/
        ...
        day/[dayIndex]/page.js         Day Hub — 4-phase journey (Pre-Stretch → Workout → Post-Stretch → Bedtime); rest day mode (recovery note + Phase 4 only); prev session hints (last working weight per exercise); coach feedback card (collapsible, unread badge, marks read on expand); read-only for past dates; adjacent day nav
