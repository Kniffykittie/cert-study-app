...
src/
  app/
    ...
    life-hub/
      ...
      my-week/page.js                  My Week — Mon–Sun day planner; day type pills (active_work/desk_work/day_off/travel); collapsible per-day detail (meal times, workout time/duration, commitments, notes); auto-saves on blur per field; week nav (prev/next); "Copy from last week" button; feeds Daily Brief and AI routes
